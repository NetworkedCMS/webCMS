...
def access():
    ...
    access_token = ApiKey.query.filter_by(id=1).first()
...
@token_required
def delete_registered_users(id):
...
@token_required
def delete_template_settings(id):
...
@token_required
def delete_slide_show_images(id):
...
@token_required
def delete_technologies_text(id):
...
@token_required
def delete_technologies_images(id):
...
@token_required
def delete_apple_touch_icon(id):
...
@token_required
def delete_background_image(id):
