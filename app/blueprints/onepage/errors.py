...
def forbidden(_):
    ...
    return render_template('OnePage/errors/403.html', footer_image=footer_image, icons=media_icons,
...
def page_not_found(_):
    ...
    testimonial = Testimonial.query.all()
    client = Client.query.all()
    return render_template('OnePage/errors/404.html', footer_image=footer_image, icons=media_icons,
                           footer_text=footer_text, slideshows=slideshows,
                           home_title=hometext, logo=logo, techno_img=techno_img,
                           text_techno=text_techno, copyright_text=copyright_text,
                           background_image=background_image, call_to_action=call_to_action,
...
def internal_server_error(_):
    ...
    testimonial = Testimonial.query.all()
    client = Client.query.all()
    return render_template('OnePage/errors/500.html', footer_image=footer_image, icons=media_icons,
                           footer_text=footer_text, slideshows=slideshows,
                           home_title=hometext, logo=logo, techno_img=techno_img,
                           text_techno=text_techno, copyright_text=copyright_text,
                           background_image=background_image, call_to_action=call_to_action,
